...
create table if not exists public.client_letters (
  ...
  case_root_id bigint references public.client_letters(id) on delete set null,
...
alter table public.client_letters
  ...
  add column if not exists case_root_id bigint references public.client_letters(id) on delete set null,
